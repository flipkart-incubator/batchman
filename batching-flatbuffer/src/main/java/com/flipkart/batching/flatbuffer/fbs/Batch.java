...
public final class Batch extends Table {
  ...
  public Tag tag(Tag obj) { int o = __offset(8); return o != 0 ? obj.__init(__indirect(o + bb_pos), bb) : null; }
  public Data dataCollection(int j) { return dataCollection(new Data(), j); }
  public Data dataCollection(Data obj, int j) { int o = __offset(10); return o != 0 ? obj.__init(__indirect(__vector(o) + j * 4), bb) : null; }
  public int dataCollectionLength() { int o = __offset(10); return o != 0 ? __vector_len(o) : 0; }
  ...
  public static int createBatch(FlatBufferBuilder builder,
    ...
    Batch.addTag(builder, tagOffset);
    return Batch.endBatch(builder);
  }

  public static void startBatch(FlatBufferBuilder builder) { builder.startObject(4); }
  ...
  public static void addDataCollection(FlatBufferBuilder builder, int dataCollectionOffset) { builder.addOffset(3, dataCollectionOffset, 0); }
